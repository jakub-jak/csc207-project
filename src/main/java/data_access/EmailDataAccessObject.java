...
public class EmailDataAccessObject implements ShareArticleEmailDataAccessInterface {
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
        ...
        final GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new InputStreamReader(EmailDataAccessObject.class.getResourceAsStream("/client_secret_517070072065-qeqlgusgdo22dad8q7uicnaat4pd35m8.apps.googleusercontent.com.json")));
    ...
    public void sendMail(String subject, String message, String rec_email) throws Exception {
        ...
        try {
            ...
            final GoogleJsonError error = googleJsonResponseException.getDetails();
            final int errorCode = 403;
            if (error.getCode() == errorCode) {
                System.err.println("Unable to send message: " + googleJsonResponseException.getDetails());
            }
            else {
                ...
                <body>
                    <div class="email-container">
                        ...
                        <div class="article-description">
                            In this article, we explore the intricacies of crafting engaging and professional HTML 
                            email templates. Learn the best practices to captivate your audience.
                        </div>
